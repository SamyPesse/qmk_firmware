...
QMK runs on any USB-capable AVR or ARM microcontroller with enough flash space - generally 32kB or more, though it will _just_ squeeze into 16kB with most features disabled.
