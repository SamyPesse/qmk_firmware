...
* Install msys2 by downloading it and following the instructions here: [http://www.msys2.org](http://www.msys2.org)
...
These are the old instructions for Windows 10. We recommend you use [MSYS2 as outlined above](getting_started_build_tools.md#windows-with-msys2-recommended).
